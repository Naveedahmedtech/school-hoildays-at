...
const zones = ["Corse"];
const location = "Corse";
const corse2024 = async (req, res, next) => {
  ...
  try {
    ...
    res.render("layouts/layout", {
      ...
      content: "../pages/zones/corse/academie/corse/year2024",
...
const corse2025 = async (req, res, next) => {
  const countdownData = req?.holidayData?.countdownData;
  ...
  try {
    ...
    res.render("layouts/layout", {
      ...
      description:
        "Bienvenue sur le calendrier officiel des vacances scolaires.",
      content: "../pages/zones/corse/academie/corse/year2025",
      vacations: updatedVacations,
    });
  } catch (error) {
    console.error("Error fetching data with axios:", error.message);
