...
const zones = ["Zone A"];
const location = "Dijon";
const dijon2024 = async (req, res, next) => {
  ...
  try {
    ...
    res.render("layouts/layout", {
      ...
      content: "../pages/zones/a/academie/dijon/year2024",
...
const dijon2025 = async (req, res, next) => {
  const countdownData = req?.holidayData?.countdownData;
  const year = "2025";
  ...
  try {
    ...
    res.render("layouts/layout", {
      ...
      description:
        "Bienvenue sur le calendrier officiel des vacances scolaires.",
      content: "../pages/zones/a/academie/dijon/year2025",
      vacations: updatedVacations,
    });
  } catch (error) {
    console.error("Error fetching data with axios:", error.message);
